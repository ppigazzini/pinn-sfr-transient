...
from pinn_sfr_transient.axial.jaxpinn.archs import N_TEMPS, AxialPinn
...
def relative_l2(
    ...
    return _score(predict(model, p, traj.zeta, traj.t, cfg), traj, p)  # type: ignore[attr-defined]
